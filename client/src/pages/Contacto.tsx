      ...
      >
        <div className="container py-10">
          <div className="flex items-center gap-2 mb-2">
            <MessageSquare className="w-5 h-5 text-[#673AB7]" />
            <span className="text-xs font-semibold text-[#673AB7] uppercase tracking-wider">Comunicaciones</span>
          </div>
          <h1
      ...
      <div className="container py-10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-6 border border-[#EDE7F6] shadow-sm">
              <h2
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#EDE7F6] flex items-center justify-center flex-shrink-0">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl p-8 border border-[#EDE7F6] shadow-sm">
              <h2
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 border border-[#EDE7F6] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#673AB7]/30 focus:border-[#673AB7] bg-[#F8F6FC] placeholder:text-gray-300"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-gray-700 mb-1.5">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-3.5 py-2.5 border border-[#EDE7F6] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#673AB7]/30 focus:border-[#673AB7] bg-[#F8F6FC] text-gray-700"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2.5 border border-[#EDE7F6] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#673AB7]/30 focus:border-[#673AB7] bg-[#F8F6FC] placeholder:text-gray-300 resize-none"
                  />
                </div>
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={enviando}
                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#673AB7] text-white font-semibold rounded-lg hover:bg-[#4527A0] transition-colors text-sm disabled:opacity-60 disabled:cursor-not-allowed shadow-sm"
                  >
                    {enviando ? (
                      <>
